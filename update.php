...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   echo "post";
    ...
    $query = "UPDATE `employe` SET `nom`='".$nom."',`prenom`='".$prenom."',`date_naissance`='".$date_naissance."',`salair`='".$salair."',`fonction`='".$fonction."',`departement`='".$departement."',`photo`='".$photo."' WHERE matricule='".$rn."' "; 
...
<body>
  ...
  <table border="0" bgcolor="black" cellspacing="25" align="center">
 <tr>
     <td >matricule</td>
